...
\hypersetup{
  pdftitle={HarvardX:PH125.9x Data Science - Capstone: MovieLens Recommendation System},
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{first\_rmse }\OtherTok{\textless{}{-}} \FunctionTok{rmse}\NormalTok{(test\_dataset}\SpecialCharTok{$}\NormalTok{rating, mean\_movie\_rating)}
